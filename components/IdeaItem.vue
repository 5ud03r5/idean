<template>
    <div class="p-2 text-gray-900 bg-gray-100 rounded-md shadow-lg h-max">
        ...
        <div class="flex justify-end flex-wrap px-1 pt-2 lg:space-x-2 max-md:text-[12px]">
            <div v-if="lfDev"
                class="px-3 py-1 text-gray-100 bg-gray-800 rounded-md max-lg:m-1 hover:cursor-pointer hover:bg-gray-700">
                LFDev</div>
            <div v-if="lfHelp"
                class="px-3 py-1 text-gray-100 bg-gray-800 rounded-md max-lg:m-1 hover:cursor-pointer hover:bg-gray-700">
                LFHelp</div>
